...
(function () {
  ...
  var resertImagesInForm = function () {
    avatarShow.src = DEFAULT_AVATAR_SRC;
    photosShow.querySelectorAll('.ad-form__photo').forEach(function (item) {
      item.remove();
    });
  ...
  window.photos = {
    resertImagesInForm: resertImagesInForm
  };
})();
